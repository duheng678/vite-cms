  ...
  <div class="content">
    ...
    <div class="table">
      <el-table :data="pageList" border style="width: 100%">
        ...
        <el-table-column align="center" label="部门名称" prop="name" width="190px" />
        <el-table-column align="center" label="部门领导" prop="leader" width="90px" />
        <el-table-column align="center" label="上级部门" prop="parentId" width="120px" />
